...
(current_graph, current_waypoints, current_waypoint_snapshots, current_edge_snapshots, current_anchors, current_anchored_world_objects) = load_map("/code/data")
cone_generator = current_graph
...
def update_cone():
    ...
    app.set("cone", VTK.scene(current_graph))
